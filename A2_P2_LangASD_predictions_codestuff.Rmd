...
```{r}
#- Create the basic model of ChildMLU as a function of Time and Diagnosis (don't forget the random effects!). Also adding extra models with interactions. 
...
```{r}
cor.test(IC_df$AIC, IC_df$cv_rmse, method = "spearman")
```
...
_We chose not to do this, as the penalized regression mainly works for ordinary linear models (not mixed effects models). Doing otherwise would take tooo much tweaking to be worth it :))_